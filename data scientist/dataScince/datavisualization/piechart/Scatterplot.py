...
f = open('C:\KALS\data science\data scientist\data scientist\dataScince\datavisualization\piechart//salesdata2.csv','r')
...
plt.scatter(s_list,c_list,marker='D',s=10,c='blue')
plt.show()
